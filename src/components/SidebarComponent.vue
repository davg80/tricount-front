          ...
          <ul class="md:flex-col md:min-w-full flex flex-col list-none">
            ...
            <li class="items-center">
              <button
                ...
                ><i class="fas fa-money-bill opacity-75 mr-2 text-sm"></i>
                Dépenses</button
              >
            </li>
            <li class="items-center">
              <button
                ...
                ><i class="fas fa-object-group opacity-75 mr-2 text-sm"></i>
                Catégories</button
              >
            </li>
          </ul>
          ...
          >
            <li class="inline-flex">
              <a
                ...
                target="_blank" 
                ><i
                  class="fas fa-code mr-2 text-blueGray-400 text-base"
                ></i>
                Back github</a
              >
            </li>
